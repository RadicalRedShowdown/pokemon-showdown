...
export const Moves: {[k: string]: ModdedMoveData} =	{
	...
	direclaw: {
		...
		shortDesc: "50% chance to slp/psn/par.",
	},
	doublekick: {
		inherit: true,
		flags: {contact: 1, protect: 1, mirror: 1, kick: 1},
	...
	myentireskeleton: {
		...
		basePower: 150,
		category: "Special",
		name: "My Entire Skeleton",
		pp: 5,
		priority: 0,
		flags: {protect: 1, mirror: 1, metronome: 1, noparentalbond: 1},
		onPrepareHit(target, source) {
			this.add('-message', `${source.name} explodes itself revealing its entire skeleton!`);
		},
		selfdestruct: "always",
		secondary: null,
		target: "allAdjacent",
		...
		shortDesc: "User faints. Blocked by Damp.",
		gen: 9,
	},
	peaburst: {
		num: -59,
		...
		target: "normal",
		type: "Grass",
		desc: "Hits four times. Boosted by Mega Launcher.",
		shortDesc: "Hits 4 times. Mega Launcher boosted.",
		gen: 9,
	},
	moongeistbeam: {
		inherit: true,
