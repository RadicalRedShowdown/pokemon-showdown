export const FormatsData: {[k: string]: ModdedSpeciesFormatsData} = {
	...
	rayquaza: {
		randomBattleLevel: 72,
		randomBattleMoves: ["dracometeor", "dragonascent", "dragondance", "extremespeed", "vcreate", "earthquake"],
		randomDoubleBattleLevel: 73,
	...
	wormadamsandy: {
		randomBattleLevel: 90,
		randomBattleMoves: ["stealthrock", "toxic", "protect", "earthpower", "bugbuzz"],
		randomDoubleBattleLevel: 91,
		randomDoubleBattleMoves: ["earthpower", "bugbuzz", "powergem", "quiverdance", "protect"],
		tier: "NU",
	},
	wormadamtrash: {
		randomBattleLevel: 89,
		randomBattleMoves: ["stealthrock", "toxic", "protect", "flashcannon", "bugbuzz"],
		randomDoubleBattleLevel: 90,
		randomDoubleBattleMoves: ["bugbuzz", "flashcannon", "strugglebug", "stealthrock", "protect"],
		tier: "NU",
	},
	mothim: {
		randomBattleLevel: 88,
	...
	spiritomb: {
		...
		randomDoubleBattleLevel: 88,
		randomDoubleBattleMoves: ["poltergeist", "protect", "snarl", "suckerpunch", "willowisp"],
		tier: "NU",
	},
	gible: {
		tier: "LC",
	...
	sandacondamega: {
		randomBattleLevel: 83,
		randomBattleMoves: ["coil", "glare", "earthquake", "return", "stealthrock", "stoneedge"],
		randomDoubleBattleLevel: 82,
